  ...
  return (
    <>
      <button
        ...
        title="Install Alive Home as PWA"
        aria-label="Install Alive Home as PWA"
      >
        <span className="dark:bg-blue-500/80 rounded-full p-1">
          <Download className="text-white" />
        </span>
        <span className="hidden lg:flex lg:flex-col items-start">
          <span className="block text-sm">Install Alive Home</span>
          <span className="text-xs block">
            Quick access to job search tools
          </span>
        </span>
        <span className="bg-blue-500 w-fit py-1.5 rounded-md px-2.5 text-white hidden lg:block">
          Install
        </span>
      </button>
    </>
