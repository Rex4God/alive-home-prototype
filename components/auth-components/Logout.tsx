...
export default function Logout({ setShowLogOut }: LogoutProps) {
  ...
  return (
    <div className="bg-white text-[#414242] p-8 rounded-[0.63rem]  mx-auto min-w-full">
      ...
      <div className="mt-12 flex space-x-4">
        <div
          className="border-[1.5px] border-slate-300 rounded-[8px] px-[28px] py-[12px] cursor-pointer text-center w-1/2 lg:w-[230px]"
